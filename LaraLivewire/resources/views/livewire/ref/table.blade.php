              ...
              <table class="w-full text-center border">
                <thead class="border-b bg-gray-50">
                  <tr>
                    ...
                    <th scope="col" class="text-md font-medium text-gray-900 px-6 py-4 border-r">{{ __('reference.group_code') }}</th>
                    <th scope="col" class="text-md font-medium text-gray-900 px-6 py-4 border-r">{{ __('reference.ref_code') }}</th>
                    <th scope="col" class="text-md font-medium text-gray-900 px-6 py-4 border-r">{{ __('reference.label') }}</th>
                    <th scope="col" class="text-md font-medium text-gray-900 px-6 py-4 border-r">{{ __('reference.label2') }}</th>
                    @can(['ref-edit', 'ref-delete'])
                ...
                <tbody>
                  ...
                  <tr class="bg-white border-b">
                    ...
                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r">{{ $item->id_ref }}
                    </td>
                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r">{{ $item->no_ref }}
                    </td>
                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r text-left">{{
                      $item->keterangan }}</td>
                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap text-left border-r">{{
                      $item->keterangan2 }}</td>
                      @can(['ref-edit', 'ref-delete'])
