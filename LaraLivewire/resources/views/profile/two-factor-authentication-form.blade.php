<x-jet-action-section>
    <x-slot name="title">
        {{ __('profil.twofactor.title') }}
    </x-slot>

    <x-slot name="description">
        {{ __('profil.twofactor.description') }}
    </x-slot>
        ...
        <h3 class="text-lg font-medium text-gray-900">
            @if ($this->enabled)
                @if ($showingConfirmation)
                    {{ __('profil.twofactor.titlefinish') }}
                @else
                    {{ __('profil.twofactor.titleenabled') }}
                @endif
            @else
                {{ __('profil.twofactor.titledisabled') }}
            @endif
        </h3>

        <div class="mt-3 max-w-xl text-sm text-gray-600">
            <p>
                {{ __('profil.twofactor.descriptionlong') }}
            </p>
        </div>
