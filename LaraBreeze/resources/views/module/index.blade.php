<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <div class="flex items-center justify-end">        
            <x-nav-link-button :href="route('module.create')" :type="'success'">
                    ...
                    <table class="table-auto w-full" id="myTable">
                        <thead class="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                            <tr>
                                ...
                                <th class="p-2"><div class="font-semibold text-center">Label</div></th>
                                <th class="p-2"><div class="font-semibold text-center">Menu</div></th>                                
                        ...
                        <tbody class="text-sm divide-y divide-gray-100">
                            ...
                            <tr>
                                ...
                                <td class="p-2">
                                    <div class="font-medium text-gray-800">{{ (isset($item->menu) ? $item->menu->name : '') }}</div>
                                </td>  
                                <td class="p-2">
                                ...
                                <td class="p-2">
                                    <div class="flex justify-center">
                                        <x-nav-link-button :href="route('module.edit', $item->id)" :type="'warning'">
