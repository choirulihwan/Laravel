<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex items-center justify-end">        
            <x-nav-link-button :href="route('user.create')" :type="'success'">
                    ...
                    <table class="table-auto w-full">
                        <thead class="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                            <tr>
                                ...
                                <th class="p-2"><div class="font-semibold text-left">Email</div></th>                                
                                <th class="p-2"><div class="font-semibold text-left">Group</div></th>                                
                        ...
                        <tbody class="text-sm divide-y divide-gray-100">
                            ...
                            <tr>
                                ...
                                <td class="p-2">
                                    <div class="font-medium text-gray-800">{{ $item->email }}</div>
                                </td>
                                <td class="p-2">
                                    <div class="font-medium text-gray-800">{{ $item->group->name }}</div>
                                </td>                                
                                <td class="p-2">
                                    <div class="flex justify-center">
                                        <x-nav-link-button :href="route('user.edit', $item->id)" :type="'warning'">
